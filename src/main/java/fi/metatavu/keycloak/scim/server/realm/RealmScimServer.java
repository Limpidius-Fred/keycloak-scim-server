...
public class RealmScimServer extends AbstractScimServer<RealmScimContext> {
    ...
    @Override
    public Response listGroups(RealmScimContext scimContext, int startIndex, int count, boolean includeMembers) {
        fi.metatavu.keycloak.scim.server.model.GroupsList groupList = groupsController.listGroups(scimContext, startIndex, count, includeMembers);
